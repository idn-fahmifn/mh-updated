            ...
            <div class="hidden lg:flex space-x-8">
                @guest
                    <x-nav-link :href="route('home')" :active="request()->routeIs('home')"
                        Icon="images/icons/home_icon_inactive.png" activeIcon="images/icons/home_icon.png">
                        {{ __('Home') }}
                    </x-nav-link>
                    <x-nav-link :href="route('floor.ground')" :active="request()->routeIs('floor.ground')"
                        Icon="images/icons/floor_icon_inactive.png" activeIcon="images/icons/floor_icon_active.png">
                        {{ __('Pilih Lantai') }}
                    </x-nav-link>
                @endguest
    ...
    <div x-show="open" class="lg:hidden">
        @guest
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('floor.ground')" :active="request()->routeIs('floor.ground')">
                    {{ __('Pilih Lantai') }}
                </x-responsive-nav-link>
            </div>
        @endguest
